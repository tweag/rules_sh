...
def rules_sh_dependencies():
    ...
    maybe(
        ...
        urls = [
            "https://github.com/bazel-contrib/bazel_features/releases/download/v1.47.1/bazel_features-v1.47.1.tar.gz",
        ],
    )
    maybe(
        http_archive,
    ...
    maybe(
        ...
        urls = [
            "https://github.com/bazelbuild/rules_python/releases/download/2.0.2/rules_python-2.0.2.tar.gz",
        ],
    )
    maybe(
        http_archive,
